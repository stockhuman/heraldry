...
export function Shape({ type }) {
  ...
  switch (type) {
    ...
    case "spanish":
      shape =
        "M40.4,4.1v434.8h0.2c0,144.1,116.9,261,261,261s261-116.9,261-261h-0.5V4.1H40.4z";
      break;
  ...
  switch (type) {
    ...
    case "gyronny":
      ordinary = (
        <g kind="gyronny">
          <polygon
            points="0 0 301.5 337 301.5 0 0 0"
            fill={match(colors[1]).hex}
          />
          <polygon
            points="0 704 301.5 337 0 337 0 704"
            fill={match(colors[1]).hex}
          />
          <polygon
            points="603 704 301.5 337 301.5 704 603 704"
            fill={match(colors[1]).hex}
          />
          <polygon
            points="603 0 301.5 337 603 337 603 0"
            fill={match(colors[1]).hex}
          />
        </g>
      );
