...
import { toCodepointString } from './util/unicodepoint'
...
export function Shape({ type }) {
  ...
  switch (type) {
    case 'swiss':
      shape =
        'M8.3,6.4c-0.5,0,98.1,32.3,147.2,32.3S299.2,6.4,302.7,6.4c2.2,0,98.1,32.3,147.2,32.3s145-32.3,147.2-32.3V93 c0,453.1-288,605.9-294.4,605.9c-13.5,0-294.4-150.4-294.4-606V6.4z'
      break
    case 'french':
      shape =
        'M301.83,704a156.39,156.39,0,0,1,44.6-22c32.49-10.11,56.8-9.41,81-10,76.27-1.87,115.27-2.82,141-23,14.32-11.23,38.61-39.45,34-117V0H.57V532c-4.61,77.55,19.68,105.77,34,117,25.73,20.18,64.73,21.13,141,23,24.2.59,48.51-.11,81,10a156.39,156.39,0,0,1,44.6,22'
      break
    case 'papal':
      shape =
        'M306.6,692.9c-1.4,2.7-4.8,3.8-7.5,2.2c-0.5-0.3-0.9-0.6-1-1c-19-38.1-50.6-52.1-91.7-50.1 c-24,1.2-48.2-1.2-72.2,0.5c-51,3.6-81.5-30.9-83.6-81.5c-0.3-6.2,0-12.4,0-18.6c0-142.9-0.9-285.7,0.6-428.5 c0.4-40.2-6.6-75-38.2-100c-1.8-1.4-2.5-3.8-1.6-6l0,0c0.3-0.6,0.9-1.6,1.3-1.6c190-0.1,380.1-0.1,572.5-0.1c4.4,0,6.9,5,4.4,8.5 c-0.7,1-1.5,1.9-2.4,2.7c-25.1,23-34.9,51.3-34.7,85.3c0.7,150.6,0.4,301.2,0.1,451.8c0,12.3-1.1,25-4.5,36.7 c-9.1,31.6-34.2,50.3-67.1,50.9c-27.2,0.5-54.4,1.2-81.5-0.1C358.3,642.1,326,654.9,306.6,692.9z'
      break
    case 'spanish':
      shape = 'M40.4,4.1v434.8h0.2c0,144.1,116.9,261,261,261s261-116.9,261-261h-0.5V4.1H40.4z'
      break

    default:
      shape =
        'M596.4,6.4c0,0,1.5,196.9,0,295.2c-1.4,94.8-6.1,168.8-48.6,226.7c-51.1,69.7-136.4,120-246.1,169.4 C192,648.2,106.8,597.9,55.6,528.2C13.2,470.4,8.4,396.4,7,301.6C5.6,203.1,5.5,104.7,7,6.4H596.4z'
  }
      ...
      division = (
        <g clipPath="url(#escutcheon)">
          ...
          <polygon
            ...
            fill={fill}
            points="52 0 329 0 329 704 27.5 796 52 704 0 616 52 528 0 440 52 352 0 264 52 176 0 88 52 0 52 0"
          />
        </g>
      )
      break
      ...
      division = (
        <g clipPath="url(#escutcheon)">
          ...
          <polygon
            ...
            points="565.31 55 565.31 0 489.94 0 489.94 55 414.56 55 414.56 0 339.19 0 339.19 55 263.81 55 263.81 0 188.44 0 188.44 55 113.06 55 113.06 0 37.69 0 37.69 55 0 55 0 423 603 423 603 55 565.31 55"
            fill={fill}
          />
        </g>
      )
...
export function Ordinaries({ type, colors, pattern = null }) {
  ...
  switch (type) {
    case 'bend-sinister':
      ordinary = (
        <rect
          ...
          width="970"
          height="136"
          transform="rotate(-45 391 391)"
          fill={match(colors[1]).hex}
        />
      )
      break
    case 'bend':
    ...
    case 'pale':
      ordinary = (
        <rect
          ...
          width="738"
          height="204"
          transform="translate(-267.11 472.61) rotate(-90)"
          fill={match(colors[1]).hex}
        />
      )
      break
    case 'cross':
      ordinary = (
        <polygon
          ...
          points="905.52 376.88 529.01 376.88 529.01 0.38 376.88 0.38 376.88 376.88 0.38 376.88 0.38 529.01 376.88 529.01 376.88 905.52 529.01 905.52 529.01 529.01 905.52 529.01 905.52 376.88"
          fill={match(colors[1]).hex}
        />
      )
      break
    case 'fess':
      ordinary = <rect kind="chief" x="0" y="220" width="970" height="150" fill={match(colors[1]).hex} />
      break
    case 'saltire':
      ordinary = (
        <polygon
          ...
          points="783.06 96.75 686.84 0.53 391.8 295.58 96.75 0.53 0.53 96.75 295.58 391.8 0.53 686.84 96.75 783.06 391.8 488.01 686.84 783.06 783.06 686.84 488.01 391.8 783.06 96.75"
          fill={match(colors[1]).hex}
        />
      )
      break
    case 'chief':
      ordinary = <rect kind="chief" x="0" y="0" width="970" height="136" fill={match(colors[1]).hex} />
      break
    case 'pile':
      ordinary = (
        <polygon
          points="310.5 710 604 0 0 0 310.5 710"
          kind="pile"
          x="0"
          y="0"
          fill={match(colors[1]).hex}
    ...
    case 'gyronny':
      ordinary = (
        <g kind="gyronny">
          <polygon points="0 0 301.5 337 301.5 0 0 0" fill={match(colors[1]).hex} />
          <polygon points="0 704 301.5 337 0 337 0 704" fill={match(colors[1]).hex} />
          <polygon points="603 704 301.5 337 301.5 704 603 704" fill={match(colors[1]).hex} />
          <polygon points="603 0 301.5 337 603 337 603 0" fill={match(colors[1]).hex} />
        </g>
      )
      break
    default:
  ...
  if (charge) {
    return (
      <image
        ...
        href={'/noto-svg/emoji_u' + toCodepointString(charge) + '.svg'}>
        {charge}
      </image>
    )
  } else return null
